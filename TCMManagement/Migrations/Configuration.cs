    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TcmContext>
    {
        ...
        protected override void Seed(TcmContext context)
        {
            ...
            context.Appointments.AddOrUpdate(
                new Appointment() { AppointmentId = 1, PersonId = 3, PatientId = 1, Description = "Headache", DateCreated = DateTime.Now, TimeStart = DateTime.Now, TimeEnd = DateTime.Now },
                new Appointment() { AppointmentId = 2, PersonId = 3, PatientId = 1, Description = "Foot pain", DateCreated = DateTime.Now, TimeStart = DateTime.Now, TimeEnd = DateTime.Now },
                new Appointment() { AppointmentId = 3, PersonId = 4, PatientId = 2, Description = "Fire", DateCreated = DateTime.Now, TimeStart = DateTime.Now, TimeEnd = DateTime.Now },
                new Appointment() { AppointmentId = 4, PersonId = 4, PatientId = 2, Description = "Water", DateCreated = DateTime.Now, TimeStart = DateTime.Now, TimeEnd = DateTime.Now }
            );

            context.TreatmentRecords.AddOrUpdate(
                new TreatmentRecord() { TreatmentRecordId = 1, PersonId = 3, PatientId = 1, Diagnosis = "Too much fire", DateCreated = DateTime.Now},
                new TreatmentRecord() { TreatmentRecordId = 1, PersonId = 3, PatientId = 1, Diagnosis = "Too much wood", DateCreated = DateTime.Now }
            );
